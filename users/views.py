...
class HouTaiView(View):
    def get(self, request):
        ...
        if user.userbianhao >= 5:
            ...
            yuechanges = YueChange.objects.filter(shifouchenggong=False, change_type='chongzhi').order_by('-change_time')[:5]
            yuechanges2 = YueChange.objects.filter(shifouchenggong=False, change_type='tixian').order_by('-change_time')[:5]
            yuechanges1 = YueChange.objects.filter(shifouchenggong=False, change_type='zhuche').order_by('-change_time')[:5]
