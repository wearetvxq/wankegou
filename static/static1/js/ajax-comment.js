            ...
            if($(this).attr('class')=='donate'){
                ...
                console.log('hello');
                 if($(this).find('img').length == 0){
                     $(this).append(' <div class="window"><img src="https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1520152127&di=f9701c87ba530a4f5c80c36f6cb452c2&src=http://b.hiphotos.baidu.com/zhidao/pic/item/b8389b504fc2d562c4aea52de21190ef77c66c4f.jpg"></div>');
                     }
            } else {
...
<<<<<<< HEAD
                console.log("click有效")
=======
>>>>>>> 45855e27ff325bc5b2c334f3ad82f84cc1920906
