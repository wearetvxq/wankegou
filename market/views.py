            ...
            if user.yue > Decimal(dog.jiage):
                ...
                if type ==-1:
                    ...
                    if mudog.shengcishu == 0:
                        ...
                        muxidaishucishujiacheng =((Decimal(0.5)*Decimal(1 + mudog.xidaishu))/mudog.shengyuzhi)* Decimal(3600)
                    else:
                        muxidaishucishujiacheng =((Decimal(0.5)*Decimal(1 + mudog.xidaishu))/mudog.shengyuzhi)* Decimal(3600)
                        for i in (1, dog.shengcishu):
                    ...
                    try:
                        nxidaishucishujiacheng = ((Decimal(0.5)*Decimal(1 + nowdog.xidaishu))/nowdog.shengyuzhi)* Decimal(3600)
